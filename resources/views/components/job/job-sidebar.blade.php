<div class="space-y-8">
    ...
    <div class="relative bg-indigo-200 rounded-sm p-5 min-w-60">
        ...
        <div class="relative">
            <div class="text-sm font-medium text-slate-800 mb-2">Remember to keep track of your job research.</div>
            <div class="text-right">
                <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">Create Alert -&gt;</a>
            </div>
        </div>
    </div>
    <!-- White box -->
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-5 min-w-60">
        <div class="grid md:grid-cols-2 xl:grid-cols-1 gap-6">
            <!-- Group 1 -->
            <div>
                <div class="text-sm text-slate-800 font-semibold mb-3">Job Types</div>
                <ul class="space-y-2">
                    <li>
                    ...
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-slate-600 font-medium ml-2">Management / Finance</span>
                        </label>
                    </li>
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-slate-600 font-medium ml-2">Customer Support</span>
                        </label>
                    </li>
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-slate-600 font-medium ml-2">Sales / Marketing</span>
                        </label>
                    </li>
                </ul>
            </div>
            <!-- Group 2 -->
            <div>
                <div class="text-sm text-slate-800 font-semibold mb-3">Company Culture</div>
                ...
                <div class="text-sm italic mt-3">Only show companies that are creating a positive culture</div>
            </div>
            <!-- Group 3 -->
            <div>
                <div class="text-sm text-slate-800 font-semibold mb-3">Salary Range</div>
                <ul class="space-y-2">
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" checked />
                            <span class="text-sm text-slate-600 font-medium ml-2">$20K - $50K</span>
                        </label>
                    </li>
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-slate-600 font-medium ml-2">$50K - $100K</span>
                        </label>
                    </li>
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-slate-600 font-medium ml-2">> $100K</span>
                        </label>
                    </li>
                    <li>
                        <label class="flex items-center">
            ...
            <!-- Group 4 -->
            <div>
                <div class="text-sm text-slate-800 font-semibold mb-3">Immigration</div>
                ...
                <div class="text-sm italic mt-3">Only show companies that can sponsor a visa</div>
            </div>
        </div>
    </div>
</div>