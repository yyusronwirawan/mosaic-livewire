    ...
    <div class="flex flex-col h-full">
        ...
        <div class="grow flex flex-col p-5">
            ...
            <div class="grow">
                <!-- Header -->
                <header class="mb-3">
                    <h3 class="text-lg text-slate-800 font-semibold">HTML, CSS, JavaScript - Build 6 Creative Projects</h3>
                </header>
                <!-- Rating and price -->
                <div class="flex flex-wrap justify-between items-center mb-4">
                    ...
                    <!-- Price -->
                    <div>
                        <div class="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">$89.00</div>
                    </div>
                </div>
                <!-- Features list -->
        ...
        <div class="grow flex flex-col p-5">
            ...
            <div class="grow">
                ...
                <div class="flex flex-wrap justify-between items-center mb-4">
                    ...
                    <!-- Price -->
                    <div>
                        <div class="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">$49.00</div>
                    </div>
                </div>
                <!-- Features list -->
                <ul class="text-sm space-y-2 mb-5">
        ...
        <div class="grow flex flex-col p-5">
            ...
            <div class="grow">
                ...
                <div class="flex flex-wrap justify-between items-center mb-4">
                    ...
                    <!-- Price -->
                    <div>
                        <div class="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">$129.00</div>
                    </div>
                </div>
                <!-- Features list -->
                <ul class="text-sm space-y-2 mb-5">
