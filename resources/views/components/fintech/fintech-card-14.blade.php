<div id="fintech-card-14" class="col-span-full bg-white shadow-lg rounded-sm border border-slate-200">
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap md:w-1/2">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-slate-800 uppercase">Twtr</div>
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap md:w-1/2">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-slate-800 uppercase">Fb</div>
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap md:w-1/2">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-slate-800 uppercase">Googl</div>
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap md:w-1/2">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-slate-800 uppercase">Aapl</div>
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap md:w-1/2">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-slate-800 uppercase">Coin</div>
