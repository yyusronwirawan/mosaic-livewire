    ...
    <div class="grow px-4 sm:px-6 md:px-5 py-4">
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-6 divide-y divide-slate-200">
            ...
            <div class="py-6" x-data="{ open: false }">
                    ...
                    <div class="grow">
                        <div class="sm:flex items-start justify-between mb-0.5">
                            ...
                            <div class="xl:flex items-center mb-2 sm:mb-0">
                                <button class="text-sm font-semibold text-slate-800 text-left truncate" @click.prevent="open = !open">Dominik Lamakani</button>
                                <div class="text-sm text-slate-400 hidden xl:block mx-1" x-show="open" x-cloak>·</div>
                                <div class="text-xs" x-show="open" x-cloak>dominiklama@acme.com</div>
                            </div>
                            <!-- Date -->
                ...
                <!-- Body -->
                <div class="text-sm text-slate-800 mt-4 space-y-2" x-show="open" x-cloak>
                ...
                <header class="flex items-start">
                    ...
                    <div class="grow">
                        <div class="sm:flex items-start justify-between mb-0.5">
                            <!-- Message author -->
                            <div class="xl:flex items-center mb-2 sm:mb-0">
                                <button class="text-sm font-semibold text-slate-800 text-left truncate" @click.prevent="open = !open">Acme Inc.</button>
                                <div class="text-sm text-slate-400 hidden xl:block mx-1" x-show="open" x-cloak>·</div>
                                <div class="text-xs" x-show="open" x-cloak>acmeinc@acme.com</div>
                            </div>
                            <!-- Date -->
                            <div class="text-xs font-medium text-slate-500 whitespace-nowrap mb-2 sm:mb-0">Sep 3, 3:18 PM</div>
                        </div>
            ...
            <div class="py-6" x-data="{ open: true }">
                ...
                <div class="text-sm text-slate-800 mt-4 space-y-2" x-show="open" x-cloak>
                    ...
                    <p>Consectetur adipiscing elit, sed do eiusmod <a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">tempor magna</a> aliqua? Check below:</p>
                    <p>
