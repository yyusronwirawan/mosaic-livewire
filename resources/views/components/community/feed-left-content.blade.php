<div class="w-full md:w-60 mb-8 md:mb-0">
    <div class="md:sticky md:top-16 md:h-[calc(100vh-64px)] md:overflow-x-hidden md:overflow-y-auto no-scrollbar">
        <div class="md:py-8">
            ...
            <!-- Title -->
            <header class="mb-6">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Feed ✨</h1>
            </header>
            ...
            <div class="xl:hidden mb-6">
                <form class="relative">
                    ...
                    <input id="feed-search-mobile" class="form-input w-full pl-9 focus:border-slate-300" type="search" placeholder="Search…" />
                    ...
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        ...
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                                ...
                                <span class="text-sm font-medium text-slate-600">Explore</span>
                            </a>
                        </li>
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        ...
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                                ...
                                <span class="text-sm font-medium text-slate-600">Self Development</span>
                            </a>
                        </li>
                    </ul>
                </div>
