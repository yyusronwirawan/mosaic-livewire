...
<article class="bg-white shadow-md rounded border border-slate-200 p-5">
    ...
    <div class="mb-2">
        <ul class="inline-flex flex-wrap text-sm font-medium">
            <li class="flex items-center">
                <a class="text-slate-500 hover:text-indigo-500" href="{{ route('forum') }}">Home</a>
                <svg class="h-4 w-4 fill-current text-slate-400 mx-2" viewBox="0 0 16 16">
                    <path d="M6.6 13.4L5.2 12l4-4-4-4 1.4-1.4L12 8z" />
                </svg>
            </li>
            <li class="flex items-center">
                <a class="text-slate-500 hover:text-indigo-500" href="#0">Discussion</a>
            </li>
        </ul>
    </div>
    <!-- Header -->
    <header class="pb-4">
        ...
        <div class="flex items-start space-x-3 mb-3">
            <h2 class="text-2xl text-slate-800 font-bold">Besides Product Hunt, where else should I promote my new project? 🤔</h2>
            <!-- Upvote button -->
            <div class="shrink-0">
                <button class="text-xs font-semibold text-center h-12 w-12 border border-slate-200 hover:border-slate-300 rounded-sm flex flex-col justify-center items-center">
                    <svg class="inline-flex fill-slate-400 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex flex-wrap text-sm">
            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">katemerlu</a>
            </div>
            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
        ...
        <ul class="space-y-5">
            ...
            <li class="relative pl-9 space-y-5">
                ...
                <div class="flex items-start">
                    ...
                    <div class="absolute top-0 left-0">
                        <button class="text-xs font-semibold text-left w-6 rounded-sm flex flex-col justify-center items-center hover:text-indigo-500">
                            <svg class="inline-flex fill-slate-400 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
                                <path d="m0 6 6-6 6 6z" />
                            </svg>
                            <div>44</div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap text-xs">
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                ...
                                <a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">ekuplu89</a>
                            </div>
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                    ...
                    <li class="relative pl-9 space-y-5">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <!-- Comment text -->
                                <div class="grow text-sm text-slate-800 space-y-2 mb-2">
                                    <p>That's great advice, <a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">@ekuplu89</a> 👏</p>
                                </div>
                                <!-- Comment footer -->
                                <div class="flex flex-wrap text-xs">
                                    <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
            ...
            <li class="relative pl-9 space-y-5">
                ...
                <div class="flex items-start">
                    <!-- Comment upvote -->
                    <div class="absolute top-0 left-0">
                        <button class="text-xs font-semibold text-left w-6 rounded-sm flex flex-col justify-center items-center">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap text-xs">
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                ...
                                <a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">markcuttik</a>
                            </div>
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                <a class="font-medium text-slate-500 hover:text-slate-600" href="#0">Reply</a>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap text-xs">
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                ...
                                <a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">davidp1</a>
                            </div>
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                <a class="font-medium text-slate-500 hover:text-slate-600" href="#0">Reply</a>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap text-xs">
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                ...
                                <a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">patrick2</a>
                            </div>
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                <a class="font-medium text-slate-500 hover:text-slate-600" href="#0">Reply</a>
                            </div>
