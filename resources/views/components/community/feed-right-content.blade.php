        ...
        <div class="md:py-8">
            ...
            <div class="mb-6">
                <form class="relative">
                    ...
                    <input id="feed-search-desktop" class="form-input w-full pl-9 focus:border-slate-300" type="search" placeholder="Search…" />
            ...
            <div class="space-y-4">
                        ...
                        <li>
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">Introductions</span>
                                    </div>
                                </div>
                                <button class="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">Join</button>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">HackerNews</span>
                                    </div>
                                </div>
                                <button class="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">Join</button>
                            </div>
                        ...
                        <li>
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">ReactJs</span>
                                    </div>
                                </div>
                                <button class="text-xs inline-flex font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2.5 py-1">
                        ...
                        <li>
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">JustChatting</span>
                                    </div>
                                </div>
                                <button class="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">Join</button>
                            </div>
                ...
                <!-- Block 2 -->
                <div class="bg-slate-50 p-4 rounded border border-slate-200">
                    <div class="text-xs font-semibold text-slate-400 uppercase mb-4">Who to follow</div>
                    <ul class="space-y-3">
                        <li>
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">Elly Boutin</span>
                                    </div>
                                </div>
                                <button class="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">Follow</button>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">Rich Harris</span>
                                    </div>
                                </div>
                                <button class="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">Follow</button>
                            </div>
                        ...
                        <li>
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">Mary Porzio</span>
                                    </div>
                                </div>
                                <button class="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">Follow</button>
                            </div>
                        ...
                        <li>
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">Brian Lovin</span>
                                    </div>
                                </div>
                                <button class="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">Follow</button>
                            </div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <div class="text-sm mb-1">
                                <a class="font-medium text-slate-800" href="#0">Tracking your website traffic on launch day 📈</a>
                            </div>
                            <div class="text-xs text-slate-500">248 comments</div>
                        </li>
                        <li>
                            <div class="text-sm mb-1">
                                <a class="font-medium text-slate-800" href="#0">Freemium model questions</a>
                            </div>
                            <div class="text-xs text-slate-500">47 comments</div>
                        </li>
                        <li>
                            <div class="text-sm mb-1">
                                <a class="font-medium text-slate-800" href="#0">Slack and Community</a>
                            </div>
                            <div class="text-xs text-slate-500">24 comments</div>
                        </li>
                        <li>
                            <div class="text-sm mb-1">
                                <a class="font-medium text-slate-800" href="#0">Who owns user onboarding in your company?</a>
                            </div>
                            <div class="text-xs text-slate-500">17 comments</div>
                        </li>
                        <li>
                            <div class="text-sm mb-1">
                                <a class="font-medium text-slate-800" href="#0">Questions from a very confused Web3 startup founder 🤔</a>
                            </div>
